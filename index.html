...
root.geometry ( '280x370' ) #display size(280==width height=370)

path = r"C:\Users\Paraganve\Desktop/banner.png"
a = Image.open ( path )
a = a.resize ( (280, 110), Image.ANTIALIAS )#image banner size(280==width , 110==height)
